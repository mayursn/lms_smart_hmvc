    ...
    $.supr = function(element, options) {
        ...
        var defaults = {
            ...
            breadcrumbs: {
                ...
                homeicon: 's16 fa fa-desktop', //home icon 
                dividerIcon: 's16 fa fa-caret-right' //divider icon
            },
            sidebar: {
            ...
            sideNav : {
                ...
                sideNavArrowIcon: 'fa fa-caret-down s16', //arrow icon for navigation
        ...
        plugin.toggleRightSidebarBtn = function(val) {
            ...
            if (val === 'hide') {   
                ...
                btn.find('i').removeClass('s16 fa fa-indent').addClass('s16 fa fa-outdent');
            }
            if (val === 'show') {
                btn.removeClass('hide-right-sidebar');
                store.set('rightSidebarToggle', 0);
                btn.find('i').removeClass('s16 fa fa-outdent').addClass('s16 fa fa-indent');
            }
        }
