...
;(function( $ ) {
	...
	function dateSlider(show, flags, eventsOpts) {
		var $eventsCalendarSlider = $("<div class='eventCalendar-slider'></div>"),
			...
			$eventsCalendarTitle = $("<div class='eventCalendar-currentTitle'><a href='#' title="Click here to show all events" class='eventCalendar-monthTitle'><i class='fa fa-calendar'></i></a></div>"),
