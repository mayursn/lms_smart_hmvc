...
class Assignment extends MY_Controller {
    ...
    function index() {
        ...
        $this->data['assignment'] = $this->Assignment_manager_model->get_all();
        ...
        $this->data['subject'] = $this->Subject_manager_model->get_all();
        $this->data['page'] = 'assignment';
    ...
    function getassignment($param = '') {
        ...
        if ($param == "submitted") {
            ...
            $subject = $this->input->post('subject');
            $semester = $this->input->post("semester");
            $this->data['submitedassignment'] = $this->Assignment_submission_model->get_submitted_subject_assignment($course, $subject, $degree, $semester);
            $this->data['param'] = $param;
        }
        ...
        if ($param == "notsubmitted") {
            ...
            $this->data['not_submitted'] = $this->Assignment_submission_model->not_submitted_assignment($course, $batch, $degree, $semester, $class, $assign_id);
            $this->data['param'] = $param;
         ...
         if ($param == "assessments") {
            ...
            $batch = $this->input->post('batch');
            $semester = $this->input->post("semester");
            $this->data['submitedassignment'] = $this->Assignment_submission_model->filter_assessment($course, $batch, $degree, $semester);
            $this->data['param'] = $param;
        }
    ...
    function submission()
    {
        ...
        $this->data['title'] = 'Assignment';
        $this->data['page'] = 'assignment';
        $this->data['assignment'] = $this->Assignment_manager_model->get_many_by(array('assign_degree' => $std->std_degree,                              
        ...
        if($_POST)
        {
         if ($_FILES['document_file']['name'] != "") {
           ...
           // $row = $this->db->get_where("assignment_manager",array("assign_id"=>$ids))->row();
            ...
            $this->flash_notification('Assignment is added successfully.');
