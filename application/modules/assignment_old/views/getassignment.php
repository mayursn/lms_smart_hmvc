...
if ($param == 'submitted') {
    ?>
    <table class="table table-striped table-bordered table-responsive" cellspacing=0 width=100% id="submited-table">
        <thead>
            <tr>
                <th>No</th>												
                <th>Assignment</th>
            ...
            foreach ($submitedassignment as $rowsub):
                ...
                <tr>
                    ...
                    <td>
                       ...
                       $name2 = $this->Subject_manager_model->get_subject_name($rowsub->sm_id);
                       echo $name2;
                        ?>													
                    </td>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#data-tables').dataTable({"language": {"emptyTable": "No data available"}});
         $('#submited-table').dataTable({"language": {"emptyTable": "No data available"}});
