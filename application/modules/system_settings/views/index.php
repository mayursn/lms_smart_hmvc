    ...
    <div class="col-lg-12">
        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
            <div class="panel-body">
                <?php echo form_open(base_url() . 'system_settings/update', array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'systemform', 'target' => '_top', 'enctype' => 'multipart/form-data'));
                ?>
                <div class=""> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="system_name" id="system_name" value="<?php echo $this->System_setting_model->get_settings('system_name'); ?>">
                    </div>
                </div>
                 <div class="form-group">
                    <label  class="col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label"><?php echo ucwords("system date format"); ?><span style="color:red">*</span></label>

                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div style="margin-left: -15px" class="col-sm-4 p-l-0">
                            <select name="system_date_format" id="system_date_format" class="form-control">  
                                <option value="">Select Date Format</option>
                                <option data-dateformatCode="F d, Y" value="F d, Y"> F d, Y  ( <?php echo date('F d, Y');  ?>)</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <input style="margin-left: -10px" type="text" class="form-control" name="phone" id="system_phone" value="<?php echo $this->System_setting_model->get_settings('phone'); ?>">
                        </div>                                                    
                    </div>
                </div>
                <div class="form-group hidden">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="paypal_email" id="paypal_email" value="<?php echo $this->System_setting_model->get_settings('paypal_email'); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label  class="col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label"><?php echo ucwords("Currency"); ?><span style="color:red">*</span></label>
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="currency" id="currency" value="<?php echo $this->System_setting_model->get_settings('currency'); ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="system_email" id="system_email" value="<?php echo $this->System_setting_model->get_settings('system_email'); ?>">
                    </div>
                </div>	                	 	
                <div class="form-group">
...
<script>
    $(document).ready(function () {
        var countryCode = '<?php echo $this->System_setting_model->get_settings('country_code'); ?>';
        $('#countryCode').val(countryCode);
        var system_date_format = '<?php echo $this->System_setting_model->get_settings('system_date_format'); ?>';
        $('#system_date_format').val(system_date_format);
        ...
        $("#systemform").validate({
            ...
            messages: {
                ...
                system_date_format:"Select date format",
