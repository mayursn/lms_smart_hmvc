<?php $this->load->model('quiz/Quiz_result_model'); ?>
<?php $this->load->model('quiz/Quiz_model'); ?>
<!-- Start .row -->
<div class=row>                      
                    ...
                    <tbody>
                        ...
                        <?php foreach ($quiz_history as $row) { ?>
                            <tr>
                                ...
                                <?php $get_history =  $this->Quiz_model->get_history_attempt($row->quiz_id,$row->user_id); ?>
                                <td><?php echo $get_history[0]->TotalAttempts; ?></td>
                                <td><?php echo $get_history[0]->BestResult; ?>/<?php echo $row->total_marks; ?></td>                            
                            <!--    <td>
